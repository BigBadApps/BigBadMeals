...
- **Agents**: start with `AGENTS.md`, then follow `standards/PLAYBOOK.md`. For GitHub PRs, auto-merge, and how agents observe CI/merge (polling, PR comments), see `AGENTS.md` and `standards/DELIVERY.md`. Product repos may add `docs/STATUS.md` (or similar) as a pause/resume handoff file.
